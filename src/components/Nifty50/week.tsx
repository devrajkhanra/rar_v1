    ...
    return <div className="grid grid-cols-1 p-3">
        <Card>
            ...
            <CardContent className="gap-3 grid grid-cols-1 sm:grid-cols-2">
                ...
                <Volume apiVol={"vol"} apiListName={"nifty50"} instrument={"Stock"} currentDates={currentDates} previousDates={previousDates} />
            </CardContent>
            ...
            <CardContent className="gap-3 grid grid-cols-1 sm:grid-cols-2">
                ...
                <Chng apiChng={"chng"} apiListName={"nifty50"} instrument={"Stock"} currentDates={currentDates} previousDates={previousDates} />
            </CardContent>
        </Card>
    </div>
}